...
public class OrderByTokenizerTests
{
    private readonly IOrderByTokenizer _orderByTokenizer;

    public OrderByTokenizerTests()
    {
        _orderByTokenizer = new OrderByTokenizer();
    }
