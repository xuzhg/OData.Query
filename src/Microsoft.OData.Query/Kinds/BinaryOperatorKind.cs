...
namespace Microsoft.OData.Query
{
    ...
    public enum BinaryOperatorKind
    {
        ...
        /// <summary>The ne operator.</summary>
        NotEqual,

        /// <summary>The gt operator.</summary>
        GreaterThan,

        /// <summary>The ge operator.</summary>
        GreaterThanOrEqual,

        /// <summary>The lt operator.</summary>
        LessThan,

        /// <summary>The le operator.</summary>
        LessThanOrEqual,
        ...
        /// <summary>The mod operator.</summary>
        Modulo,

        /// <summary>The has operator.</summary>
        Has,
    }
}
