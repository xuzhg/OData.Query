...
{
    public class ExpandTokenizor : IExpandTokenizor
    {
        public virtual ExpandToken TokenizeExpand(string expand)
        {
            IExpressionLexer lexer = new ExpressionLexer(expand);
            ...
            itemTokens.Add(ParseSingleExpandItem());
        ...
        protected virtual ExpandItemToken ParseSingleExpandItem()
        {
