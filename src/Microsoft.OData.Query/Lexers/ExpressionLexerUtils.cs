...
/// <summary>
/// Utilities needed by <see cref="IExpressionLexer"/> which are relatively simple and standalone.
/// </summary>
internal static class ExpressionLexerUtils
{
    /// <summary>
    ...
    internal static bool IsNumericTokenKind(ExpressionKind kind)
        => kind == ExpressionKind.IntegerLiteral ||
           kind == ExpressionKind.DecimalLiteral ||
           kind == ExpressionKind.DoubleLiteral ||
           kind == ExpressionKind.Int64Literal ||
