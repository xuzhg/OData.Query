...
/// </summary>
public class AllNode : LambdaNode
{
    /// <summary>
    ...
    public AllNode(CollectionValueNode source, Collection<RangeVariable> rangeVariables, RangeVariable currentRangeVariable, SingleValueNode body)
    ...
    /// </summary>
    public override QueryNodeKind Kind => QueryNodeKind.All;
}